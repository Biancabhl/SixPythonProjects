...
def ahorcado():
    ...
    while len(letras_por_adivinar) > 0 and vidas > 0:
        ...
        #Si la letra escogida por el usuario esta en el abecedario y no esta en el conjunto de letras que ya se han ingresado, se anhade la letra al conjunto de letras ingresadas.
